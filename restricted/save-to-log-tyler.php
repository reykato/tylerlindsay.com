<?php
  ...
  $index_filename = '/home3/tylersay/public_html/messages/v2.1/tyler/index.log';
  $index = file_get_contents($index_filename);
  $index_updated = intval($index) + 1;
  $log_filename = '/home3/tylersay/public_html/messages/v2.1/tyler/' . strval($index_updated) . '.txt';
